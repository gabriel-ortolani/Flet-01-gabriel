...
def main(page: ft.Page):
    ...
    inp_texto = ft.TextField(label="Texto", width=300, value="Texto de exemplo para configurar 🎨")
    def aplicar(e):
         # Atualiza o texto do preview ao clicar no botão
        area_preview.content.value = inp_texto.value
        aplicar_config(e)
        page.update()
    btn_aplicar = ft.ElevatedButton(text="Aplicar Texto", width=100, on_click=aplicar)
    texto = ft.Row([
        inp_texto, btn_aplicar
    ])
    # Área de preview
    area_preview = ft.Container(
        content=ft.Text(inp_texto.value, size=16, color=ft.Colors.BLACK),
        ...
        ft.Column([
            ...
            ft.Row([
                ...
                ft.Column([
                    ...
                    dropdown_cor, dropdown_fundo, texto
                ], spacing=10)
